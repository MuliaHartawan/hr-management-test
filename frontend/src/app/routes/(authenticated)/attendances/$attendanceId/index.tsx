...
import { Table, TableBody, TableCell, TableHead, TableRow } from '@/app/_components/ui/table';
                ...
                <Table>
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell>{data?.employee.first_name} {data?.employee.last_name}</TableCell>
                        </TableRow>
                        <TableRow >
                        ...
                        <TableRow >
                            ...
                            <TableCell>{data?.clock_out ? data?.clock_out : "No clock out"}</TableCell>
                        </TableRow>
                        <TableRow >
